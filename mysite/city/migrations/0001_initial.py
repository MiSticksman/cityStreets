...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('route_comp_id', models.AutoField(primary_key=True, serialize=False)),
                ('follow_up_number', models.IntegerField()),
                ('house', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='city.house')),
                ('route', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='city.route')),
            ],
            options={
